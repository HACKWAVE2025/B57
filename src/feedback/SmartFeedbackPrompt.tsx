    ...
    switch (trigger) {
      case "session_complete":
        return {
          ...
          description:
            "You've completed a study session. We'd love to hear your feedback.",
          icon: CheckCircle,
          color: "green",
        };
      case "task_complete":
      ...
      case "file_upload":
        return {
          ...
          description:
            "How was the upload process? Any suggestions for improvement?",
          icon: CheckCircle,
          color: "purple",
        };
      case "ai_interaction":
        return {
          ...
          description:
            "How helpful was the AI assistant? Your feedback helps us improve.",
          icon: Sparkles,
          color: "orange",
        };
      default:
        return {
          ...
          description:
            "We'd love to hear your feedback to improve Super Study.",
          icon: Heart,
          color: "blue",
        };
    }
          ...
          >
            <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-lg shadow-lg p-4">
              <div className="flex items-start gap-3">
                <div
                  className={`w-10 h-10 bg-gradient-to-r from-${content.color}-500 to-${content.color}-600 rounded-lg flex items-center justify-center flex-shrink-0`}
                >
